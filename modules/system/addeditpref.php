...
<form name="changeuser" action="./index.php?m=system" method="post">
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="1" class="std">
		...
		<tr>
			...
			<td>
				<?php
				// CUSTOMIZADO: Idioma fixo em Português Brasileiro
				echo '<input type="hidden" name="pref_name[LOCALE]" value="pt_br" />';
				echo '<strong>Português Brasileiro</strong>';
				?>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<?php
				// CUSTOMIZADO: Tema fixo como Modern
				echo '<input type="hidden" name="pref_name[UISTYLE]" value="modern" />';
				echo '<strong>Modern (Premium)</strong>';
				?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left"><input class="button" type="button" value="<?php echo $AppUI->_('back'); ?>"
					onclick="javascript:history.back(-1);" /></td>
			<td align="right"><input class="button" type="button" value="<?php echo $AppUI->_('submit'); ?>"
					onclick="javascript:submitIt()" /></td>
		</tr>
	</table>
</form>